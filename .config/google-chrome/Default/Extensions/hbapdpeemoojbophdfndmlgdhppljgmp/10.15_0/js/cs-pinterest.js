var Tool = (function(){
  ...
  var initWidgetsRoot = function(){
    ...
    var $divs = $('.mainContainer > .zI7 > div');
  ...
  var renderSearchInsights = function(data){
    ...
    if (!$root[0]) {
      ...
      $root.html([
        ...
        `<h3><img src="${chrome.extension.getURL('img/icon64.png')}" width="24" height="24"> Search Insights</h3>`,
  ...
  var renderTrendsChart = function(params, data){
    ...
    let html = [
      '<h3 class=""><img src="' + chrome.extension.getURL('/img/icon24.png') + '" width="24" height="24" style="vertical-align:middle"> Trend Data For "' + params.query + ' (' + geo + ')"</h3>',
      '<div class="xt-copy-export-row">',
